...
export default async function CompetitiveAnalysisPage({ searchParams }: { searchParams?: { ideaId?: string } }) {
  ...
  const toShow = sections.filter(s => s.section === "Competitor Analysis (Direct & Indirect)");
