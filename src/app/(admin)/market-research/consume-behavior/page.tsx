...
export default async function ConsumerBehaviorPage({ searchParams }: { searchParams?: { ideaId?: string } }) {
  ...
  const toShow = sections.filter(s => s.section === "Target Market & Customer Segments");

  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold">Consumer Behavior</h1>
      {toShow.length === 0 ? (
