...
export default async function MarketSizeGrowthPage({ searchParams }: { searchParams?: { ideaId?: string } }) {
  ...
  const toShow = sections.filter(s => s.section === "Market Size (TAM, SAM, SOM)");

  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold">Market Size & Growth Potential</h1>
      {toShow.length === 0 ? (
