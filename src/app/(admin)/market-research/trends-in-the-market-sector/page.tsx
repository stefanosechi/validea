...
export default async function TrendsInMarketSectorPage({ searchParams }: { searchParams?: { ideaId?: string } }) {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-semibold">Trends in the Market Sector</h1>
      {toShow.length === 0 ? (
